  ...
  <header>
    <nav>
      ...
      <ul>
        ...
        <li id="logout"></li>
        <script>
          var isAuthenticated = <?php echo json_encode($isAuthenticated); ?>;
          var userLinks = document.getElementById('user-links');
          var logout = document.getElementById('logout');
          if (isAuthenticated) {
            userLinks.innerHTML = `<a href="user.php"><i data-feather="user-check"></i></a>`;
              logout.innerHTML = `<a href="logout.php"><i data-feather="log-out"></i></a>`;
          } else {
